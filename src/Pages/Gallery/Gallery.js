...
export default class Gallery extends Component {
    ...
    constructor(props) {
        ...
        {id: 2, season: 'Høst 2022', pictures: ['./Høst2022/1.png','./Høst2022/2.png',
        './Høst2022/3.png','./Høst2022/4.png','./Høst2022/5.png','./Høst2022/6.png']}, 
        {id: 3, season: 'Vår 2022', pictures: ['test',"test2"]}, 
        {id: 4, season: 'Vinter 2022', pictures: ['test',"test2"]}]};
            ...
            <div className="font-display bg-white ">
                <Tabs className="flex flex-row" selectedTabClassName="border-r-0 bg-sky-200">
                    ...
                    <div className="w-full">
                        <h2 className="flex justify-center pt-10 text-4xl font-black">Hvis fram din stil</h2>
                        <h3 className="flex justify-center pb-10 text-2xl">La oss hjelpe deg</h3>
                        {this.state.seasons.map(sea => {
                                return (
                                <TabPanel className=" grid gap-2 grid-rows-2 justify-items-center mr-5 grid-span-2 grid-flow-col  ">
                                    {sea.pictures.map(picture => {
                                        return (
                                            <img src={picture} alt={picture} className="h-96 bg-violet-400"></img>
                                        )        
                                    })}
                                </TabPanel>
                                );
